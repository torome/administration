...
<template>
    <validator lazy name="validation">
        ...
        <div class="col-sm-10">
            <input v-model="port" id="port" type="text" class="form-control" placeholder="请输入端口号" v-validate:port="{ required: { rule: true, message: "端口不能为空" } }">
        ...
        <div class="col-sm-10">
            <input v-model="path" id="path" type="text" class="form-control" placeholder="请输入路径" v-validate:path="{ required: { rule: true, message: "路径不能为空" } }">
        ...
        <div class="col-sm-10">
            <input v-model="user" id="user" type="text" class="form-control" placeholder="请输入用户名" v-validate:user="{ required: { rule: true, message: "用户名不能为空" } }">
        ...
        <div class="col-sm-10">
            <input v-model="password" id="password" type="text" class="form-control" placeholder="请输入密码" v-validate:password="{ required: { rule: true, message: "密码不能为空" } }">
