            ...
            <div class="box-body">
                ...
                <validity field="fileMaxSize" :validators="{ required: { rule: true, message: '附件大小不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('fileMaxSize')">{{ errors.first('fileMaxSize') }}</span>
                        </div>
                    </div>
                </validity>
                <validity field="imageMaxSize" :validators="{ required: { rule: true, message: '图片大小不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('imageMaxSize')">{{ errors.first('imageMaxSize') }}</span>
                        </div>
                    </div>
                </validity>
                <validity field="videoMaxSize" :validators="{ required: { rule: true, message: '视频大小不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('videoMaxSize')">{{ errors.first('videoMaxSize') }}</span>
                        </div>
                    </div>
                </validity>
                <validity field="canUploadImageExtension" :validators="{ required: { rule: true, message: '扩展名不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('canUploadImageExtension')">{{ errors.first('canUploadImageExtension') }}</span>
                        </div>
                    </div>
                </validity>
                <validity field="canUploadCatcherExtension" :validators="{ required: { rule: true, message: '扩展名不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('canUploadCatcherExtension')">{{ errors.first('canUploadCatcherExtension') }}</span>
                        </div>
                    </div>
                </validity>
                <validity field="canUploadVideoExtension" :validators="{ required: { rule: true, message: '扩展名不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('canUploadVideoExtension')">{{ errors.first('canUploadVideoExtension') }}</span>
                        </div>
                    </div>
                </validity>
                <validity field="canUploadFileExtension" :validators="{ required: { rule: true, message: '扩展名不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('canUploadFileExtension')">{{ errors.first('canUploadFileExtension') }}</span>
                        </div>
                    </div>
                </validity>
                <validity field="canManagementImageExtension" :validators="{ required: { rule: true, message: '扩展名不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('canManagementImageExtension')">{{ errors.first('canManagementImageExtension') }}</span>
                        </div>
                    </div>
                </validity>
                <validity field="canManagementFileExtension" :validators="{ required: { rule: true, message: '扩展名不能为空' } }">
                    <div class="form-group" :class="{ 'has-error': errors.has('domain') }">
                        ...
                        <div class="col-sm-5">
                            <span class="help-block" v-show="errors.has('canManagementFileExtension')">{{ errors.first('canManagementFileExtension') }}</span>
                        </div>
                    </div>
                </validity>
                <div class="form-group">
