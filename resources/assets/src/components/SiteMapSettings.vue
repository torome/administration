                    ...
                    <div class="form-group" :class="{ 'has-error': $validation.updateCycle.invalid }">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input id="update-cycle" v-model="updateCycle" type="text" class="form-control" placeholder="请输入更新周期" v-validate:update-cycle="{ required: { rule: true, message: '更新周期不能为空' } }">
