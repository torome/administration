            ...
            <form class="form-horizontal" novalidate @submit="onSubmit">
                <div class="box-body">
                    <div class="form-group"
                         :class="{ 'has-error': $validation.minAddWidth.invalid || $validation.minAddHeight.invalid }">
                        <label class="col-sm-2 control-label">图片附件大小控制</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">为 GIF 添加水印</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">水印字体大小</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">水印效果预览</label>
                        <div class="col-sm-10">
